    ...
    <div className="portfolio">
      ...
      <ul className="portfolio__projects">
        <li className="portfolio__project">
          <a className="portfolio__link" href="https://github.com/MaksimPozharskiy/how-to-learn">
        ...
        <li className="portfolio__project">
          <a className="portfolio__link" href="https://github.com/MaksimPozharskiy/russian-travel">
        ...
        <li className="portfolio__project">
          <a className="portfolio__link" href="https://github.com/MaksimPozharskiy/react-mesto-api-full">
